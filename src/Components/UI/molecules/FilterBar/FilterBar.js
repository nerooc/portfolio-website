...
class FilterBar extends React.Component {
  ...
  renderFilterOptions() {
    return Object.keys(this.filters).map(filterOption => {
      const filterOptionValue = this.filters[filterOption];
      return (
        <li
          onClick={this.handleFilterChange.bind(this, filterOptionValue)}
